        ...
        outputs = plaidml.exec.run(
            ...
            [(
                ...
                np.array([
                    [1, 2, 3],  #
                    [4, 5, 6 + (1 << 12)],  #
                    [16777223, 2147483656, 4294967295]
                ], dtype=plaidml.DType.UINT64.into_numpy()))])
        self.assertEqual(outputs[0].tolist(), [[1, 2, 3], [4, 5, 6 + (1 << 12)], [16777223, 2147483656, 4294967295]])
